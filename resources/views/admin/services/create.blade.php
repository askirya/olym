...
@section('header', 'Создание услуги')
            ...
            <div>
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="available" class="rounded border-gray-300 dark:border-gray-700 text-admin-600 shadow-sm focus:border-admin-500 focus:ring focus:ring-admin-500 focus:ring-opacity-50 transition-colors duration-300" {{ old('available') ? 'checked' : '' }}>
