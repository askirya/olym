        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white shadow-sm focus:border-admin-500 focus:ring focus:ring-admin-500 focus:ring-opacity-50 transition-colors duration-300" value="{{ old('name', $product->name) }}" required>
                </div>
            ...
            <div>
                <div class="mb-4">
                    ...
                    @if($product->image)
                    <div class="mb-2">
                        <img src="{{ asset($product->image) }}" alt="{{ $product->name }}" class="h-32 w-auto object-cover rounded-md">
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="in_stock" class="rounded border-gray-300 dark:border-gray-700 text-admin-600 shadow-sm focus:border-admin-500 focus:ring focus:ring-admin-500 focus:ring-opacity-50 transition-colors duration-300" {{ old('in_stock', $product->in_stock) ? 'checked' : '' }}>
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">В наличии</span>
                    </label>
                </div>
            </div>
        </div>
